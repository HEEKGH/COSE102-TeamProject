...
# 과목 목록 반환 및 제2외국어 분류 추가
def get_subjects_with_languages(data):
    ...
    # 제2외국어 분류
    if '제2외국어 한문' in main_subjects:
        language_subjects = data[data['영역'] == '제2외국어 한문']['유형'].drop_duplicates().tolist()
        sub_subjects['제2외국어 한문'] = language_subjects
...
if __name__ == "__main__":
    ...
    if year in years:
        ...
        if data is not None:
            main_subjects, sub_subjects = get_subjects_with_languages(data)
